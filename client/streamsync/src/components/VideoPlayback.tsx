...
export default function FireTVVideoPlayer({ socket , roomId }: { socket: Socket, roomId: string }) {
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-green-400 font-medium">Connected to Room: {roomId}</span>
                  </div>
                  <Button
